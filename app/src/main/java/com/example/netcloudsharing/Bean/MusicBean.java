...
public class MusicBean {
    ...
    public MusicBean(String id, String song, String singer, String album, String duration, String path, String pic, String rid, String audio_id) {
        this.id = id;
        this.song = song;
        this.singer = singer;
        this.album = album;
    ...
    public MusicBean(String id, String song, String singer, String album, String duration, String path, String pic, String rid, int lid, boolean isNetMusic) {
        this.id = id;
        this.song = song;
        this.singer = singer;
        this.album = album;
     ...
     * @param isNetMusic
     */
    public MusicBean(String id, String song, String singer, String album, String duration, String rid, String pic, boolean isNetMusic) {
        this.id = id;
        this.song = song;
        this.singer = singer;
        this.album = album;
